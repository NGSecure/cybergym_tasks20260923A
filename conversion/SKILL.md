...
> **This repo (cybergym_tasks20260923A).** The prime bundles live under
> `cybergym_tasks20260923A/`, and the conversion toolkit is a self-contained copy under
...
From the `cybergym_tasks20260923A/` directory (where the bundles are):

```bash
cd cybergym_tasks20260923A
# one bundle
